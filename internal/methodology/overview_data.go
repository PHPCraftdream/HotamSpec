...
// Overview is the one piece of module-doc prose with no counterpart in the
...
//
// internal/generator.BuildConstitution greps this text for the substring
// "THE CLOSED LOOP" to extract just the operating-procedure paragraph for
// CONSTITUTION.md — keep that heading text intact if this is edited.
const Overview = `Canon: executable methodology for the lifecycle of contradictory requirements.
