...
> Full claim + WHY + assumptions: `domains/fixture-domain/docs/gen/REQUIREMENTS.md` (roster) · enforcement detail: `domains/fixture-domain/docs/gen/UNENFORCED.md`.
