...
func TestGenSpec_SmokeOnRealDomain(t *testing.T) {
	...
	builds := []build{
		...
		{"PIPELINE.md", func(g *ontology.Graph) string { return BuildPipeline(g, "hotam-spec-self", nil) }},
...
func TestSmoke_EveryBuildTemplateOnRealDomainNoPanicNoEmpty(t *testing.T) {
	...
	builds := []build{
		...
		{"AGENT-CONTEXT.md", func(g *ontology.Graph) string {
			return BuildAgentContext(g, "hotam-spec-self", 27646, "2026-07-12", false)
		}},
		{"live-state.md", func(g *ontology.Graph) string { return BuildLiveState(g, "hotam-spec-self", 27646, "2026-07-12") }},
	}
	for _, b := range builds {
