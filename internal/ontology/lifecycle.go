...
var ConflictLifecycle = Lifecycle{
	...
	Transitions: []Transition{
		{Src: "DETECTED", Dst: "ACKNOWLEDGED", Event: "steward-acknowledge"},
		{Src: "ACKNOWLEDGED", Dst: "DECIDED", Event: "steward-decide", Guard: "rationale or derived requirement recorded"},
		{Src: "ACKNOWLEDGED", Dst: "REVISIT_WHEN", Event: "steward-park", Guard: "revisit condition recorded"},
		{Src: "ACKNOWLEDGED", Dst: "HELD", Event: "steward-hold", Guard: "decided_by recorded and >=2 variants attached"},
		...
		{Src: "HELD", Dst: "DECIDED", Event: "steward-choose-variant", Guard: "rationale names the chosen variant"},
	},
