...
- **graph:** 299 nodes (req+conflict+assumption); OP-director budget 150000 chars (CRYSTAL_CHARS measure) — resident crystal 27646 chars (headroom 122354)
...
| **§Invariants** | `spec/src/hotam_spec/invariants.py` | 47 checks | 29 tests |
...
- **R-binary-enforcement-gradient** (REJECTED) — REPLACES by R-enforcement-first-class — (was: external-review backlog item D3 — binarize the enforcement gradient.) — (was: External-review backlog item D3. Proposed to binarize the enforcement scale.)
...
_(showing 12 of 40, alphabetical by id — full history: docs/gen/HISTORY.md)_
