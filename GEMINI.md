...
- **top action:** [P0] REFLECTION on `enforcement-gradient` — 40 SETTLED requirements are closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL) — claimed but not guaranteed, soft context-debt. See docs/gen/UNENFORCED.md.
- **debt:** 162/236 SETTLED ENFORCED · 2 DRAFT · 0 OPEN · 40 closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL)
...
- **open actions** — 1 (top: [P0] enforcement-gradient: 40 SETTLED requirements are closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL) — claimed but not guaranteed, soft context-debt.)
<!-- DOMAIN-MAP:END -->
<!-- CONSTITUTION:BEGIN -->
<!-- (generated by `go run ./cmd/hotam gen-spec` — do not hand-edit) -->
