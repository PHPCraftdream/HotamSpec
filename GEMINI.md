...
- **top action:** [P0] REFLECTION on `enforcement-gradient` — 38 SETTLED requirements are closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL) — claimed but not guaranteed, soft context-debt. See docs/gen/UNENFORCED.md.
- **debt:** 164/237 SETTLED ENFORCED · 2 DRAFT · 0 OPEN · 38 closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL)
- **graph:** 305 nodes (req+conflict+assumption); OP-director budget 150000 chars (CRYSTAL_CHARS measure) — resident crystal 16458 chars (headroom 133542)
...
- **open actions** — 1 (top: [P0] enforcement-gradient: 38 SETTLED requirements are closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL) — claimed but not guaranteed, soft context-debt.)
<!-- DOMAIN-MAP:END -->
<!-- CONSTITUTION:BEGIN -->
<!-- (generated by `go run ./cmd/hotam gen-spec` — do not hand-edit) -->
