...
- [boot_cite_status](spec/docs/tools/boot_cite_status.md) — Stop-hook writer + reader that lexically checks whether the operator's first sentence cites a typed anchor.
...
- **debt:** 198/224 SETTLED ENFORCED · 4 DRAFT · 1 OPEN · 4 closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL)
- **graph:** 287 nodes (req+conflict+assumption); OP-director budget 150000 chars (CRYSTAL_CHARS measure) — resident crystal 26209 chars (headroom 123791)
...
**Operator** — R-agent-code-imports-framework [E] · R-agent-never-lost [E] · R-budget-measure [E] · R-context-bounded-delegation [E] · R-crystal-carries-short-form [S] · R-operator-prompt-from-substrate [E]
...
| **§Conflict** | `spec/src/hotam_spec/conflict.py` | 17 checks | 9 tests |
...
_(showing 12 of 35, alphabetical by id — full history: docs/gen/HISTORY.md)_
