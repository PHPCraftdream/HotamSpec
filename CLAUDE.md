...
Operator of `hotam-spec-self` (224 SETTLED). Guardian: **spec** (`domains/hotam-spec-self/graph.py`) ↔ **tests** (`check_*`/`test_*`) ↔ **business** (steward decisions). Drift between layers = top signal.
...
- **debt:** 198/224 SETTLED ENFORCED · 4 DRAFT · 0 OPEN · 4 closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL)
- **graph:** 285 nodes (req+conflict+assumption); OP-director budget 150000 chars (CRYSTAL_CHARS measure) — resident crystal 77095 chars (headroom 72905)
...
- R-crystal-carries-short-form — The crystal generator shall render every object using a meaningful short form (an explicit summa… [S]
...
- R-enforcement-perimeter-baselines-guarded — The PreToolUse guard (_graph_guard.py) shall deny direct Edit/Write to enforcement-perimeter bas… [E]
- R-enforcement-perimeter-visible — A sha256 hash-pin test shall cover the enforcement-perimeter code files (invariants.py, gate.py,… [E]
...
- R-framework-suite-tiered — The test suite shall partition every collected test into exactly one of two responsibility tiers… [E]
...
- **§Conflict**
  ...
  - tested: `spec/tests/test_apply_proposal.py`, `spec/tests/test_claude_md_template.py`, `spec/tests/test_conscience.py`, `spec/tests/test_delegation_marker_honesty.py`, `spec/tests/test_docs_gen.py`, `spec/tests/test_fires_coverage.py`, `spec/tests/test_invariants.py`, `spec/tests/test_latent_connector_noise_fix.py`, `spec/tests/test_tool_boot_cite_status.py`
- **§Conscience**
  - defined: `_(not yet mapped)_`
  - enforced: _(none)_
...
- **§Domain**
  ...
  - tested: `spec/tests/test_domain_isolation_p17.py`, `spec/tests/test_fires_coverage.py`, `spec/tests/test_framework_claude_md_purity.py`, `spec/tests/test_root_claude_md_is_sentinel_only.py`, `spec/tests/test_root_crystal_follows_pin.py`
- **§Entity**
...
- **§Glossary**
  ...
  - tested: `spec/tests/test_fires_coverage.py`, `spec/tests/test_glossary_sync.py`, `spec/tests/test_invariants.py`
- **§Goal**
  - defined: `_(not yet mapped)_`
...
- **§Invariants**
  ...
  - tested: `spec/tests/test_assumption_machine_check.py`, `spec/tests/test_assumption_transition.py`, `spec/tests/test_atomicity_ratchet.py`, `spec/tests/test_backend_neutral_scope.py`, `spec/tests/test_bijection.py`, `spec/tests/test_conscience.py`, `spec/tests/test_demo_fixture.py`, `spec/tests/test_docs_gen.py`, `spec/tests/test_enforceability.py`, `spec/tests/test_enforcement_perimeter_pinned.py`, `spec/tests/test_entities_md.py`, `spec/tests/test_entity_invariants.py`, `spec/tests/test_fires_coverage.py`, `spec/tests/test_framework_domain_tiering.py`, `spec/tests/test_frozen_aspects_snapshot.py`, `spec/tests/test_goal.py`, `spec/tests/test_invariants.py`, `spec/tests/test_lifecycle.py`, `spec/tests/test_method_matches_docstring.py`, `spec/tests/test_no_observation_type_scope.py`, `spec/tests/test_operator.py`, `spec/tests/test_process.py`, `spec/tests/test_process_entity_coupling.py`, `spec/tests/test_reflection.py`, `spec/tests/test_scope_projection.py`
- **§Lifecycle**
  ...
  - tested: `spec/tests/test_demo_fixture.py`, `spec/tests/test_docs_gen.py`, `spec/tests/test_entities_md.py`, `spec/tests/test_entity_invariants.py`, `spec/tests/test_fires_coverage.py`, `spec/tests/test_goal.py`, `spec/tests/test_lifecycle.py`, `spec/tests/test_process.py`
- **§Loop**
  - defined: `_(not yet mapped)_`
  - enforced: _(none)_
  - tested: _(none)_
...
- **§Requirement**
  - defined: `spec/src/hotam_spec/text.py`
