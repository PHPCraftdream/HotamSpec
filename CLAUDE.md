...
- **top action:** [P0] REFLECTION on `enforcement-gradient` — 21 SETTLED requirements are PROSE/STRUCTURAL — claimed but not guaranteed, soft context-debt. See docs/gen/UNENFORCED.md.
- **debt:** 38/59 SETTLED ENFORCED · 24 DRAFT · 13 OPEN · 21 SETTLED-unenforced
- **graph:** 118 nodes (req+conflict+assumption); OP-director budget 200 (headroom 82)
