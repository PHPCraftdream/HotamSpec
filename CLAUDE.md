...
- **top action:** [P0] REFLECTION on `burn-down` — DRAFT-overhang: 24 DRAFT vs 45 SETTLED — promote DRAFTs toward ENFORCED before crystallizing more (R-crystallize-before-split, C-06e2d84e).
- **debt:** 27/45 SETTLED ENFORCED · 24 DRAFT · 13 OPEN · 18 SETTLED-unenforced
- **graph:** 100 nodes (req+conflict+assumption); OP-director budget 200 (headroom 100)
