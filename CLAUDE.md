...
Operator of `hotam-spec-self` (225 SETTLED). Guardian: **spec** (`domains/hotam-spec-self/graph.py`) ↔ **tests** (`check_*`/`test_*`) ↔ **business** (steward decisions). Drift between layers = top signal.
...
- **debt:** 197/225 SETTLED ENFORCED · 4 DRAFT · 1 OPEN · 4 closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL)
- **graph:** 289 nodes (req+conflict+assumption); OP-director budget 150000 chars (CRYSTAL_CHARS measure) — resident crystal 26160 chars (headroom 123840)
...
**Discipline** — R-active-loop-apply-tool [E] · R-active-loop-playbook-doc [E] · R-active-loop-protocol [E] · R-crystallize-before-split [S] · R-crystallize-knowledge-to-code [S] · R-delegation-conclusions-only [S] · R-prefer-tool-over-hand [S] · R-shared-tools-in-spec-tools [E] · R-task-spawn-is-a-hand [S] · R-task-spawn-log-runtime [E] · R-task-vs-action-distinct-altitudes [S] · R-verify-closure-per-action [E] · R-working-vs-substrate-budget [E]
...
_(showing 12 of 36, alphabetical by id — full history: docs/gen/HISTORY.md)_
