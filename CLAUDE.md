...
Operator of `hotam-spec-self` (192 SETTLED). Guardian: **spec** (`domains/hotam-spec-self/graph.py`) ↔ **tests** (`check_*`/`test_*`) ↔ **business** (steward decisions). Drift between layers = top signal.
...
- **debt:** 164/192 SETTLED ENFORCED · 7 DRAFT · 0 OPEN · 10 closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL)
- **graph:** 246 nodes (req+conflict+assumption); OP-director budget 150000 chars (CRYSTAL_CHARS measure) — resident crystal 58830 chars (headroom 91170)
