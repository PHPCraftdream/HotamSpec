...
- **top action:** [P0] REFLECTION on `enforcement-gradient` — 10 SETTLED requirements are closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL) — claimed but not guaranteed, soft context-debt. See docs/gen/UNENFORCED.md.
- **debt:** 166/194 SETTLED ENFORCED · 7 DRAFT · 0 OPEN · 10 closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL)
- **graph:** 248 nodes (req+conflict+assumption); OP-director budget 150000 chars (CRYSTAL_CHARS measure) — resident crystal 60599 chars (headroom 89401)
