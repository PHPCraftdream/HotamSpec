...
Operator of `hotam-spec-self` (220 SETTLED). Guardian: **spec** (`domains/hotam-spec-self/graph.py`) ↔ **tests** (`check_*`/`test_*`) ↔ **business** (steward decisions). Drift between layers = top signal.
...
- **debt:** 195/220 SETTLED ENFORCED · 5 DRAFT · 0 OPEN · 3 closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL)
- **graph:** 280 nodes (req+conflict+assumption); OP-director budget 150000 chars (CRYSTAL_CHARS measure) — resident crystal 75697 chars (headroom 74303)
- **crystal:** OK — under 130000 char warn threshold (host cap 150000)
- context: 27% (Opus 4.8 (1M context) @ 2026-07-05T05:52:37+00:00)
<!-- LIVE-STATE:END -->
<!-- DOMAIN-MAP:BEGIN -->
<!-- (generated by tools/gen_spec.py — do not hand-edit) -->
