...
- **graph:** 292 nodes (req+conflict+assumption); OP-director budget 150000 chars (CRYSTAL_CHARS measure) — resident crystal 26739 chars (headroom 123261)
...
- **open actions** — 40 (top: [P0] R-active-loop-playbooks: REJECTED requirement 'R-active-loop-playbooks' claims a REPLACES successor in prose but has NO structural `replaces` edge — migrate it vi...)
<!-- DOMAIN-MAP:END -->
<!-- CONSTITUTION:BEGIN -->
<!-- (generated by tools/gen_spec.py — do not hand-edit) -->
