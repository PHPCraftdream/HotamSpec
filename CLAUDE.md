...
- **graph:** 292 nodes (req+conflict+assumption); OP-director budget 150000 chars (CRYSTAL_CHARS measure) — resident crystal 26809 chars (headroom 123191)
...
- **open actions** — 17 (top: [P0] R-axes-as-module-constant: REJECTED requirement 'R-axes-as-module-constant' claims a REPLACES successor in prose but has NO structural `replaces` edge — migrate it ...)
<!-- DOMAIN-MAP:END -->
<!-- CONSTITUTION:BEGIN -->
<!-- (generated by tools/gen_spec.py — do not hand-edit) -->
