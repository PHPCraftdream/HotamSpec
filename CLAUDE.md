...
Operator of `hotam-spec-self` (198 SETTLED). Guardian: **spec** (`domains/hotam-spec-self/graph.py`) ↔ **tests** (`check_*`/`test_*`) ↔ **business** (steward decisions). Drift between layers = top signal.
...
- **debt:** 178/198 SETTLED ENFORCED · 5 DRAFT · 0 OPEN · 0 closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL)
- **graph:** 255 nodes (req+conflict+assumption); OP-director budget 150000 chars (CRYSTAL_CHARS measure) — resident crystal 63490 chars (headroom 86510)
