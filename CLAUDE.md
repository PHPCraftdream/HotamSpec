...
Operator of `hotam-spec-self` (233 SETTLED). Guardian: **spec** (`domains/hotam-spec-self/graph.json`) ↔ **tests** (`check_*`/`Test_*`) ↔ **business** (steward decisions). Drift between layers = top signal.
...
- **graph:** 301 nodes (req+conflict+assumption); OP-director budget 150000 chars (CRYSTAL_CHARS measure) — resident crystal 14930 chars (headroom 135070)
...
- **atoms-count** — 233 SETTLED
- **open actions** — 1 (top: [P0] enforcement-gradient: 91 SETTLED requirements are closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL) — claimed but not guaranteed, soft context-debt. See doc...)
<!-- DOMAIN-MAP:END -->
<!-- CONSTITUTION:BEGIN -->
<!-- (generated by `go run ./cmd/hotam gen-spec` — do not hand-edit) -->
...
Operator (7) · Substrate / Anchoring (3) · Discipline (14) · Check / Invariant (20) · Framework Self (2) · Lifecycle / Process / Goal (2) · Boot / Glossary / History / Docs (2) · Other (71)
<!-- CONSTITUTION:END -->
<!-- AGENT-MAP:BEGIN -->
<!-- (generated by `go run ./cmd/hotam gen-spec` — do not hand-edit) -->
