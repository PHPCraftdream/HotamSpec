...
- **open actions** — 1 (top: [P0] enforcement-gradient: 37 SETTLED requirements are closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL) — claimed but not guaranteed, soft context-debt.)
<!-- DOMAIN-MAP:END -->
<!-- CONSTITUTION:BEGIN -->
<!-- (generated by `go run ./cmd/hotam gen-spec` — do not hand-edit) -->
