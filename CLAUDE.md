...
- **graph:** 285 nodes (req+conflict+assumption); OP-director budget 150000 chars (CRYSTAL_CHARS measure) — resident crystal 25688 chars (headroom 124312)
...
| **§Closure** | `spec/src/hotam_spec/enforcer_resolution.py` | 2 checks | 2 tests |
