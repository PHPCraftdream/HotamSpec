...
Operator of `hotam-spec-self` (189 SETTLED). Guardian: **spec** (`domains/hotam-spec-self/graph.py`) ↔ **tests** (`check_*`/`test_*`) ↔ **business** (steward decisions). Drift between layers = top signal.
...
- **debt:** 161/189 SETTLED ENFORCED · 7 DRAFT · 1 OPEN · 10 closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL)
- **graph:** 243 nodes (req+conflict+assumption); OP-director budget 150000 chars (CRYSTAL_CHARS measure) — resident crystal 57173 chars (headroom 92827)
...
- **§Invariants**
  ...
  - tested: `spec/tests/test_atomicity_ratchet.py`, `spec/tests/test_backend_neutral_scope.py`, `spec/tests/test_bijection.py`, `spec/tests/test_conscience.py`, `spec/tests/test_demo_fixture.py`, `spec/tests/test_docs_gen.py`, `spec/tests/test_enforceability.py`, `spec/tests/test_entities_md.py`, `spec/tests/test_entity_invariants.py`, `spec/tests/test_frozen_aspects_snapshot.py`, `spec/tests/test_goal.py`, `spec/tests/test_invariants.py`, `spec/tests/test_lifecycle.py`, `spec/tests/test_method_matches_docstring.py`, `spec/tests/test_no_observation_type_scope.py`, `spec/tests/test_operator.py`, `spec/tests/test_process.py`, `spec/tests/test_process_entity_coupling.py`, `spec/tests/test_reflection.py`
- **§Lifecycle**
