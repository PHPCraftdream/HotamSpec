...
- **debt:** 204/232 SETTLED ENFORCED · 2 DRAFT · 0 OPEN · 2 closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL)
...
| **§Invariants** | `spec/src/hotam_spec/invariants.py` | 47 checks | 28 tests |
