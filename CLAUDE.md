...
Operator of `hotam-spec-self` (197 SETTLED). Guardian: **spec** (`domains/hotam-spec-self/graph.py`) ↔ **tests** (`check_*`/`test_*`) ↔ **business** (steward decisions). Drift between layers = top signal.
...
- **debt:** 176/197 SETTLED ENFORCED · 5 DRAFT · 0 OPEN · 1 closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL)
- **graph:** 254 nodes (req+conflict+assumption); OP-director budget 150000 chars (CRYSTAL_CHARS measure) — resident crystal 63006 chars (headroom 86994)
