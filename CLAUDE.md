...
Operator of `hotam-spec-self` (184 SETTLED). Guardian: **spec** (`domains/hotam-spec-self/graph.py`) ↔ **tests** (`check_*`/`test_*`) ↔ **business** (steward decisions). Drift between layers = top signal.
...
- **debt:** 159/184 SETTLED ENFORCED · 7 DRAFT · 2 OPEN · 10 closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL)
- **graph:** 237 nodes (req+conflict+assumption); OP-director budget 150000 chars (CRYSTAL_CHARS measure) — resident crystal 56204 chars (headroom 93796)
