...
Operator of `hotam-spec-self` (226 SETTLED). Guardian: **spec** (`domains/hotam-spec-self/graph.py`) ↔ **tests** (`check_*`/`test_*`) ↔ **business** (steward decisions). Drift between layers = top signal.
...
- **debt:** 197/226 SETTLED ENFORCED · 2 DRAFT · 1 OPEN · 5 closeable debt (ENFORCEABLE, still PROSE/STRUCTURAL)
- **graph:** 290 nodes (req+conflict+assumption); OP-director budget 150000 chars (CRYSTAL_CHARS measure) — resident crystal 26193 chars (headroom 123807)
