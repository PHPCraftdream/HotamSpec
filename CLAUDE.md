...
- **open actions** — 39 (top: [P0] R-active-loop-playbooks: REJECTED requirement 'R-active-loop-playbooks' claims a REPLACES successor in prose but has NO structural `replaces` edge — migrate it vi...)
<!-- DOMAIN-MAP:END -->
<!-- CONSTITUTION:BEGIN -->
<!-- (generated by tools/gen_spec.py — do not hand-edit) -->
