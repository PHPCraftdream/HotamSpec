...
- **top action:** [P0] REFLECTION on `enforcement-gradient` — 16 SETTLED requirements are PROSE/STRUCTURAL — claimed but not guaranteed, soft context-debt. See docs/gen/UNENFORCED.md.
- **debt:** 26/42 SETTLED ENFORCED · 6 DRAFT · 13 OPEN · 16 SETTLED-unenforced
- **graph:** 79 nodes (req+conflict+assumption); OP-director budget 200 (headroom 121)
