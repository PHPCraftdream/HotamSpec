...
- **inspect** — Usage: hotam inspect [--domain <path>] [--json] [--limit N]. Advisory listing of semantic conflict candidates with evidence (internal/diagnose): shared-assumption clusters, entity-state suspects, lexical claim overlap, axis co-reference. Never gates; exit code always 0. Ported (`hotam inspect`).
...
**REJECTED (REPLACES known)** (40) — R-active-loop-playbooks · R-agent-has-own-crystal · R-agent-imports-framework

_(showing 3 of 40, alphabetical by id — full history + WHY: docs/gen/HISTORY.md, `hotam req show <id>`)_
