...
- **debt:** 65/111 SETTLED ENFORCED · 21 DRAFT · 13 OPEN · 46 SETTLED-unenforced
- **graph:** 178 nodes (req+conflict+assumption); OP-director budget 200 (headroom 22)
...
- **§Domain**
  ...
  - tested: `spec/tests/test_domain_isolation_p17.py`, `spec/tests/test_framework_claude_md_purity.py`
- **§Glossary**
