...
- **debt:** 67/113 SETTLED ENFORCED · 21 DRAFT · 13 OPEN · 46 SETTLED-unenforced
...
- **R-no-hand-edit-graph** — *Changes to domains/*/graph.py shall be made only through tools/apply_proposal.py; direct hand-edits are prohibited outside of bootstrap events.* [STRUCTURAL]
...
- **R-root-claude-md-is-sentinel-only** — *The root CLAUDE.md shall contain ONLY a minimal framework-identity header plus sentinel-bounded generated blocks; no large hand-written prose sections between sentinels.* [ENFORCED·test_root_claude_md_is_sentinel_only]
