...
- **debt:** 103/134 SETTLED ENFORCED · 14 DRAFT · 7 OPEN · 31 SETTLED-unenforced
- **graph:** 189 nodes (req+conflict+assumption); OP-director budget 200 (headroom 11)
...
- **§Entity**
  ...
  - enforced: `check_entity_field_kind_known`, `check_entity_instance_id_prefix`, `check_entity_instance_refs_resolve`, `check_entity_instance_required_fields`, `check_entity_instance_state_in_lifecycle`, `check_entity_type_lifecycle_wellformed`, `check_process_drives_existing_entities`, `check_step_invokes_known_transition`, `check_typed_anchors_entity`
  - tested: `spec/tests/test_entity_invariants.py`, `spec/tests/test_process_entity_coupling.py`, `spec/tests/test_tool_create_entity_type.py`
- **§Glossary**
...
- **§Lifecycle**
  ...
  - tested: `spec/tests/test_docs_gen.py`, `spec/tests/test_entity_invariants.py`, `spec/tests/test_goal.py`, `spec/tests/test_lifecycle.py`, `spec/tests/test_process.py`
- **§Loop**
  - defined: `_(not yet mapped)_`
  - enforced: _(none)_
  - tested: _(none)_
...
- **§Process**
  ...
  - tested: `spec/tests/test_docs_gen.py`, `spec/tests/test_process.py`, `spec/tests/test_process_entity_coupling.py`
- **§Proposal**
