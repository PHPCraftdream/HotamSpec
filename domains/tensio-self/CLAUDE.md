...
- **top action:** [P0] REFLECTION on `enforcement-gradient` — 32 SETTLED requirements are PROSE/STRUCTURAL — claimed but not guaranteed, soft context-debt. See docs/gen/UNENFORCED.md.
- **debt:** 104/136 SETTLED ENFORCED · 14 DRAFT · 7 OPEN · 32 SETTLED-unenforced
- **graph:** 191 nodes (req+conflict+assumption); OP-director budget 200 (headroom 9)
