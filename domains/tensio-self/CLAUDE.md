...
- **debt:** 105/140 SETTLED ENFORCED · 14 DRAFT · 7 OPEN · 35 SETTLED-unenforced
- **graph:** 195 nodes (req+conflict+assumption); OP-director budget 200 (headroom 5)
...
- **§Agent**
  ...
  - tested: `spec/tests/test_agent_scoped_constitution.py`, `spec/tests/test_domain_isolation_p17.py`
- **§Assumption**
