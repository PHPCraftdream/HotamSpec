...
| `R-agent-conduct-is-rules-not-tests` | ATOMIC |  |
...
| `R-assumption-implements-state` | ATOMIC |  |
| `R-assumption-transition-kind-exists` | ATOMIC |  |
| `R-atomicity-ratchet-no-growth` | ATOMIC |  |
| `R-attention-agent-agnostic-core` | ATOMIC |  |
| `R-attention-claude-adapter` | ATOMIC |  |
| `R-attention-registry` | ATOMIC |  |
| `R-attention-superset-of-diagnose` | ATOMIC |  |
...
| `R-conflict-resolved-in-members-or-mediator` | ATOMIC |  |
| `R-conflict-structurally-visible` | ATOMIC |  |
| `R-confront-includes-aspirations` | ATOMIC |  |
...
| `R-crystal-carries-short-form` | ATOMIC |  |
...
| `R-enforcement-perimeter-baselines-guarded` | ATOMIC |  |
| `R-enforcement-perimeter-visible` | ATOMIC |  |
...
| `R-framework-suite-domain-independent` | ATOMIC |  |
| `R-framework-suite-tiered` | ATOMIC |  |
...
| `R-machine-check-syntactic` | ATOMIC |  |
...
| `R-project-root-not-hardcoded` | ATOMIC |  |
| `R-proposed-conflict-kind-exists` | ATOMIC |  |
| `R-proposed-stakeholder-kind-exists` | ATOMIC |  |
...
| `R-signoff-preserved-in-substrate` | ATOMIC |  |
| `R-smoke-test` | ATOMIC |  |
...
| `R-tension-audit-shortlist-tool` | ATOMIC |  |
| `R-tension-audit-staleness-visible` | ATOMIC |  |
| `R-three-cipher-pulse-structurally-injected` | ATOMIC |  |
| `R-ticket-carries-history` | ATOMIC |  |
| `R-ticket-engine-on-disk` | ATOMIC |  |
| `R-ticket-mutation-via-tools-only` | ATOMIC |  |
...
| `check_assumption_machine_checks_syntactic` | ATOMIC |  |
| `check_assumption_status_valid` | ATOMIC |  |
...
| `check_decided_conflict_carries_signoff` | ATOMIC |  |
...
| `check_enforced_by_test_has_teeth` | ATOMIC |  |
...
| `check_method_matches_docstring` | COMPOUND | 4 distinct violation messages (docstring declares 3 sub-rules) |
...
| `check_signoff_chosen_variant_resolves` | ATOMIC |  |
