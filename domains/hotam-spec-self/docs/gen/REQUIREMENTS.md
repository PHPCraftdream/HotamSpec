...
| `R-domain-owns-claude-md` | SETTLED | `framework-author` | A-python-stack | Each `domains/<name>/CLAUDE.md` is the domain-scoped operator-prompt, generated by `gen_spec.py`. |
| `R-framework-claude-md-is-domain-free` | SETTLED | `framework-author` | A-python-stack | The root `CLAUDE.md` shall contain only framework-level content, referencing domains exclusively through the DOMAIN-MAP block. |
...
| `R-root-claude-md-contains-domain-crystal` | SETTLED | `framework-author` | A-python-stack | Root CLAUDE.md shall embed the full content of the active domain's CLAUDE.md inside a DOMAIN-CRYSTAL sentinel block generated by gen_spec.py. |
