...
| `R-agent-imports-framework` | DRAFT | `framework-author` | A-content-free-honest | An agent's code shall import the framework body (`hotam_spec.*`) as shared infrastructure; the framework body is owned by no single agent. |
