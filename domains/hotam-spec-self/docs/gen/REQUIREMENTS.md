...
| `R-work-within-launch-dir` | SETTLED | `framework-author` | — | The operator shall confine all file mutations to its launch working directory, never modifying anything outside it -- including the host harness and the global configuration -- unless the user explicitly requests otherwise. |
