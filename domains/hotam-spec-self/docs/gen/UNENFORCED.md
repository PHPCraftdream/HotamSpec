...
**Burn-down: SETTLED-ENFORCED 115 / SETTLED 151; closeable debt 27; inherent discipline 9; DRAFT 12; OPEN 7; REJECTED 23.**
...
| `R-operator-crystal-embeds-thinking` | test_embedded_thinking_tools.py::test_embedded_thinking_sentinels_present, test_embedded_thinking_tools.py::test_embedded_thinking_contains_full_topic_content | The operator's CLAUDE.md shall embed the full content of its scope-relevant thinking documentation inline, not as markdown links, so the operator holds the methodology itself rather than a table of contents. |
| `R-operator-crystal-embeds-tools` | test_embedded_thinking_tools.py::test_embedded_tools_sentinels_present, test_embedded_thinking_tools.py::test_embedded_tools_contains_full_tool_content, test_embedded_thinking_tools.py::test_embedded_blocks_regen_byte_identical | The operator's CLAUDE.md shall embed the full content of its scope-relevant tool documentation inline, not as markdown links. |
