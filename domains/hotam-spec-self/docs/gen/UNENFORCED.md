...
**Burn-down: SETTLED-ENFORCED 120 / SETTLED 157; closeable debt 28; inherent discipline 9; DRAFT 12; OPEN 7; REJECTED 25.**
...
| `R-sub-agent-crystal-triad` | STRUCTURAL | `framework-author` | Every sub-agent's CLAUDE.md shall contain three parts: scope-filtered embedded methodology thinking, a reference to its parent/senior agent, and its own scope-filtered domain business (CONSTITUTION). |
