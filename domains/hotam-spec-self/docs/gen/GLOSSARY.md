...
| `§Agent` | A scoped sub-operator directory (domains/<domain>/agents/<name>/) with scope.py, CLAUDE.md, tools/, agents/, and docs/ subdirectories. |
...
| `apply_proposal` | The mechanical writer that lands a steward-approved proposal into the domain's graph.py; the AI never edits the graph by hand. |
