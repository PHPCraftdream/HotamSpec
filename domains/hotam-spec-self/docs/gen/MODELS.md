...
**24 file(s) scanned; 13 object(s); 0 typed error(s).**
...
## `internal/generator/pipeline_livestate_test.go`
...
### `UnknownPredicateError` (struct)

UnknownPredicateError reports an unrecognized predicate value passed to a tally function (an unknown lifecycle_class, status, or enforcement) — the fail-closed signal internal/invariants' evalOrientationAssert turns into a violation naming the offending FAQ entry, rather than a tally silently returning zero for a typo.
...
## `internal/invariants/authored_prose_snapshot_test.go`

package `invariants`

_No exported objects or typed errors in this file._

## `internal/invariants/history_signoff_checks_test.go`

package `invariants`

_No exported objects or typed errors in this file._

## `internal/invariants/orientation_faq_assert.go`

package `invariants`

_No exported objects or typed errors in this file._

## `internal/invariants/orientation_faq_assert_test.go`
...
## `internal/proposal/history_signoff_test.go`
