...
**Other** — R-commit-follows-review [P] · R-host-spawn-leaves-trace [S] · R-land-leaves-trace [E] · R-push-only-on-request [P] · R-spawn-logged [S] · R-t1-gate-is-default [E] · R-wave-lands-atomically [S] · R-wave-strictly-sequential [S] · R-worktree-parallel-permitted [P]
