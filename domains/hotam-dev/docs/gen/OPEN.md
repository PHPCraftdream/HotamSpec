...
Open requirements: **0**. Unresolved conflicts: **2**.
...
| `C-80687260` | `sequential-vs-isolated-parallel` | DETECTED | `dev-steward` | R-wave-strictly-sequential, R-worktree-parallel-permitted |
