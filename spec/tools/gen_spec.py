...
def _reader_header_line(doc_kind: str, g: TensionGraph) -> str:
    ...
    """
    return _doc_reader_line(doc_kind, stakeholder_ids(g))
...
def build_shared_thinking_docs(
    ...
    reader_line = _doc_reader_line("SHARED_THINKING", reader_stakeholder_ids)
...
def build_shared_tool_docs(
    ...
    if reader_stakeholder_ids is None:
        try:
            ...
            reader_stakeholder_ids = frozenset()
    reader_line = _doc_reader_line("SHARED_TOOL", reader_stakeholder_ids)
    result: dict[str, str] = {}
