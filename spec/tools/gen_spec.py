...
def _render_embedded_thinking_block() -> str:
    ...
    '#### <slug>' heading before its full doc body, so the embedded copy is
    addressable the same way the standalone spec/docs/thinking/<slug>.md is.
    """
...
def _render_embedded_tools_block() -> str:
    ...
    determinism reason as _render_embedded_thinking_block(). Each tool gets
    its own '#### <basename>' heading before its full doc body.
    """
