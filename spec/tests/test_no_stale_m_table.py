...
The canonical M-registry lives in domains/tensio-self/docs/gen/DECISIONS.md
...
def test_root_claude_md_has_no_m_table_rows() -> None:
    ...
    assert offending == [], (
        ...
        "Remove them — the canonical registry is domains/tensio-self/docs/gen/DECISIONS.md.\n"
        + "\n".join(offending[:5])
    )
...
def test_root_claude_md_links_to_decisions_md() -> None:
    ...
    text = ROOT_CLAUDE.read_text(encoding="utf-8")
    needle = "domains/tensio-self/docs/gen/DECISIONS.md"
