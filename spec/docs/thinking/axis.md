...
## From `spec/src/tensio/axis.py` (module)
...
## From `spec/src/tensio/axis.py::Axis`
...
## From `spec/src/tensio/graph.py::axis_slugs`
...
## From `spec/src/tensio/invariants.py::check_axis_in_registry`
