...
## From `spec/src/tensio/conflict.py` (module)
...
## From `spec/src/tensio/conflict.py::conflict_identity`
...
## From `spec/src/tensio/conflict.py::Conflict`
...
## From `spec/src/tensio/conflict.py::is_unresolved`
...
## From `spec/src/tensio/conflict.py::is_decided`
...
## From `spec/src/tensio/graph.py::conflicts_by_axis`
...
## From `spec/src/tensio/graph.py::members_pair_set`
...
## From `spec/src/tensio/graph.py::LatentSuspect`
...
## From `spec/src/tensio/graph.py::latent_connector_suspects`
...
## From `spec/src/tensio/invariants.py::check_conflict_id_matches_identity`
...
## From `spec/src/tensio/invariants.py::check_steward_not_a_member_owner`
...
## From `spec/src/tensio/invariants.py::check_decided_has_rationale_or_derived`
