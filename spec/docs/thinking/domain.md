...
## From `spec/src/tensio/invariants.py::check_domain_manifest_exists_and_importable`
...
## From `spec/src/tensio/invariants.py::check_domain_manifest_id_matches_dirname`
...
## From `spec/src/tensio/invariants.py::check_domain_manifest_description_nonempty`
...
## From `spec/src/tensio/invariants.py::check_domain_manifest_goals_nonempty`
...
## From `spec/src/tensio/invariants.py::check_domain_manifest_director_nonempty`
