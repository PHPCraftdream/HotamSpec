...
### Tool reference — 17 Implemented, 27 Planned. Full list with usage: `hotam -h`. Structured pulse: `hotam status --json`. Agentic access: `hotam req` / `hotam brief`. Complete registry: docs/gen/tools/INDEX.md, internal/methodology/tools_data.go.
<!-- EMBEDDED-TOOLS:END -->
...
- **graph:** 305 nodes (req+conflict+assumption); OP-director budget 150000 chars (CRYSTAL_CHARS measure) — resident crystal 15033 chars (headroom 134967)
