...
11 сигналов, ~2512 chars инжекта. 3 ложных (wave16-*.json «awaiting resolver» — атомы посажены, файлы не заархивированы); 2 стухших (T-1/T-2 на сделанные волны); revisit C-8600b1b8 перевзвёлся через 2 дня. Дедупа нет, снапшота «что уже показывал» нет.
