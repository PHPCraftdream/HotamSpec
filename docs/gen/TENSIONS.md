...
| `R-active-loop-playbooks` | `R-bijection-r-to-enforcer` | shares assumption(s): A-prose-suffices |
| `R-active-loop-playbooks` | `R-check-method-is-atomic` | shares assumption(s): A-prose-suffices |
...
| `R-active-loop-playbooks` | `R-prefer-tool-over-hand` | shares assumption(s): A-stakeholders-care |
...
| `R-active-loop-playbooks` | `R-requirement-claim-is-atomic` | shares assumption(s): A-prose-suffices |
...
| `R-agent-has-own-crystal` | `R-operator-acting-facet` | shares assumption(s): A-finite-context-operators |
...
| `R-agent-has-own-tools-dir` | `R-operator-acting-facet` | shares assumption(s): A-finite-context-operators |
...
| `R-agent-is-a-directory` | `R-operator-acting-facet` | shares assumption(s): A-finite-context-operators |
...
| `R-backend-scope` | `R-operator-acting-facet` | shares assumption(s): A-finite-context-operators |
...
| `R-claude-md-budget-phi-cap` | `R-operator-acting-facet` | shares assumption(s): A-finite-context-operators |
...
| `R-claude-md-tree-of-crystals` | `R-goal-as-target-state` | shares assumption(s): A-bootstrap-self-applies |
...
| `R-claude-md-tree-of-crystals` | `R-operator-acting-facet` | shares assumption(s): A-finite-context-operators |
...
| `R-claude-md-tree-of-crystals` | `R-statemachine-wellformedness` | shares assumption(s): A-bootstrap-self-applies |
...
| `R-constituting-requirements-converge` | `R-goal-as-target-state` | shares assumption(s): A-bootstrap-self-applies |
...
| `R-constituting-requirements-converge` | `R-statemachine-wellformedness` | shares assumption(s): A-bootstrap-self-applies |
...
| `R-context-hook-piggybacks-cah-stamp` | `R-operator-acting-facet` | shares assumption(s): A-finite-context-operators |
...
| `R-domain-delegation-as-node` | `R-operator-acting-facet` | shares assumption(s): A-finite-context-operators |
...
| `R-domain-delegation-persists` | `R-operator-acting-facet` | shares assumption(s): A-finite-context-operators |
...
| `R-goal-as-target-state` | `R-operator-prompt-from-substrate` | shares assumption(s): A-bootstrap-self-applies |
...
| `R-operator-acting-facet` | `R-operator-backend-protocol` | shares assumption(s): A-finite-context-operators |
| `R-operator-acting-facet` | `R-partition-vs-border` | shares assumption(s): A-finite-context-operators |
| `R-operator-acting-facet` | `R-subagent-gets-its-claude-md` | shares assumption(s): A-finite-context-operators |
| `R-operator-acting-facet` | `R-task-spawn-is-ephemeral` | shares assumption(s): A-finite-context-operators |
| `R-operator-acting-facet` | `R-task-spawn-log-runtime` | shares assumption(s): A-finite-context-operators |
| `R-operator-acting-facet` | `R-tree-of-crystals-cognitive-trigger` | shares assumption(s): A-finite-context-operators |
...
| `R-operator-prompt-from-substrate` | `R-statemachine-wellformedness` | shares assumption(s): A-bootstrap-self-applies |
