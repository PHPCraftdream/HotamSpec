...
**Burn-down: SETTLED-ENFORCED 56 / SETTLED 102; DRAFT 21; OPEN 13; REJECTED 18.**
...
| `R-domain-owns-claude-md` | STRUCTURAL | `framework-author` | Each `domains/<name>/CLAUDE.md` is the domain-scoped operator-prompt, generated by `gen_spec.py`. |
