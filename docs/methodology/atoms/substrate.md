...
**Enforced by:** `test_framework_claude_md_purity.py::test_exactly_one_claude_md_in_repo`
...
**Enforced by:** `test_hand_written_note_in_template_survives_regen`, `test_claude_md_template.py::test_regen_byte_identical`
...
**Enforced by:** `check_domain_manifest_exists_and_importable`, `test_tool_create_domain.py::test_creates_required_files`
